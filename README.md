# TABG-Map-Editor
## Installation
**.** Download `TABGMapEditor.zip` from [releases](https://github.com/JunaidIRF/TABG-Map-Editor/releases) and extract it.
...
**.** Join Our [Discord]() For Updates, Help, Requests and more.
